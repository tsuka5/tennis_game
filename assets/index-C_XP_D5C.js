...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function cl(){return new Yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Za(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function ll(){return new Yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Za(),fragmentShader:`
...
#define LOW_PRECISION`),t}function z_(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===fh?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===dh?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Mn&&(t="SHADOWMAP_TYPE_VSM"),t}function H_(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Hi:case Vi:t="ENVMAP_TYPE_CUBE";break;case Or:t="ENVMAP_TYPE_CUBE_UV";break}return t}function V_(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Vi:t="ENVMAP_MODE_REFRACTION";break}return t}function G_(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ph:t="ENVMAP_BLENDING_MULTIPLY";break;case $f:t="ENVMAP_BLENDING_MIX";break;case qf:t="ENVMAP_BLENDING_ADD";break}return t}function W_(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function X_(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=z_(e),l=H_(e),h=V_(e),u=G_(e),f=W_(e),d=I_(e),g=D_(r),_=s.createProgram();let m,p,E=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(us).join(`
`)),o=Sa(o),o=yl(o,e),o=Sl(o,e),a=Sa(a),a=yl(a,e),a=Sl(a,e),o=Ml(o),a=Ml(a),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
